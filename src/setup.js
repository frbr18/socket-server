/**
 * Connect to database and add some default data
 */
"use strict";

const mongo = require("mongodb").MongoClient;
const dsn = process.env.DBWEBB_dsb || "localhost:27017/mumin";
...
// do it ? call the funktion
resetCollection(dsn, "crowds", docs)
/**
